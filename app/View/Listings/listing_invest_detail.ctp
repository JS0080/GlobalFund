...
<div class="col-md-10">
    <div class="col-md-12 text-center ">
        ...
        <p>  Offering Size: <?php echo $projects['BasicsDetail']['offering_size']; ?></p>
    ...
    <div class="col-md-12 text-center">
        ...
        <div title="<?php echo $projects['BasicsDetail']['offering_size']; ?>%" style="margin: auto; text-align: center; width: 40%;">
            <div style="text-align: left; margin: 2px auto; font-size: 0px; line-height: 0px; border: solid 1px #AAAAAA; background: #DDDDDD; overflow: hidden; ">
                <div style="font-size: 0px; line-height: 0px; height: 15px; min-width: 0%; max-width: <?php echo $projects['BasicsDetail']['percentage_completed']; ?>%; width: 48%; background: none repeat scroll 0px 0px rgb(29, 61, 141);"><!----></div></div>
            <div style="font-size: 8pt; font-family: sans-serif; "><?php echo $projects['BasicsDetail']['percentage_completed']; ?>%</div></div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        ...
                        <a class=" btn btn-default invest  pull-right  " href="<?php echo $this->Html->url(array('controller' =>'listings','action' =>'listing_partner_detail',$projects['BasicsDetail']['user_id'])); ?>" style="padding:2px 8px; background-color:#FFFFFF; border:#245d8f solid 1px; text-transform: capitalize; color:#677bb1; font-size:12px; ">View Profile</a>
                    </h4>
                </div>
