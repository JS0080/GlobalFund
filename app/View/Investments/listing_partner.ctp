            ...
            <div class="col-md-12 ">
                <div class="clearfix grey_bg">
                   <?php if(!empty($listing['ListingDetail']['id'])) { ?>                   
                    ...
                    <?php } ?>
                    <h4 class="border_bottom"><?php echo $listing['ListingDetail']['company_name'] ?><br/>
                        <small><?php echo $listing['User']['city'] ?> ,<?php echo $listing['User']['state'] ?></small>
                    </h4>
                    <h4>Bio/About</h4>
                    <p style="padding:10px; text-align:justify;">
                          <?php echo substr($listing['ListingDetail']['about_bio'] , 0,120); ?>
                    </p>	
