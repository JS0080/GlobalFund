                ...
                <div class="col-md-12">  
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">    
                              ...
                              <?php   echo $this->html->link($users['ListingDetail']['upload_bio'], '/investments/download/'.$users['ListingDetail']['upload_bio']."/ListingPartnerPortfolio", array('escape'=>false, 
                                                'target'=>'_blank', 'style'=>'text-decoration:none; color:#ffa985;')); ?>
                                </span></p>  
                            <p class="clearfix"><b class="col-xs-offset-1 col-lg-3">Portfolio </b><span class="col-lg-8"><a href="<?php echo SITEPATH."investments/download/".$users['ListingDetail']['portfolio']."/ListingPartnerPortfolio" ?>" target="_blank"><?php echo $users['ListingDetail']['portfolio']?></a></span></p>  
                            <p class="clearfix"><b class="col-xs-offset-1 col-lg-3">Executive Summary</b><span class="col-lg-8"><a href="<?php echo SITEPATH."investments/download/".$users['ListingDetail']['executive_summary']."/ListingPartnerPortfolio" ?>" target="_blank"><?php echo $users['ListingDetail']['executive_summary']?></a></span></p>
                            <p class="clearfix"><b class="col-xs-offset-1 col-lg-3">Team / Leaders Bio</b><span class="col-lg-8"><a href="<?php echo SITEPATH."investments/download/".$users['ListingDetail']['team_leadership']."/ListingPartnerPortfolio" ?>" target="_blank"><?php echo $users['ListingDetail']['team_leadership']?></a></span></p> 
...
<!--                            <p class="clearfix"><b class="col-xs-offset-1 col-lg-3">Company Bio </b><span class="col-lg-8"><a href="#" target="_blank"><?php echo $users['ListingDetail']['upload_bio']?></a></span></p>  
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages"> 
                           ...
                           <div role="tabpanel" class="tab-pane clearfix" id="projects">   
                                ...
                                <?php foreach($projects as $investment){ ?>
                             
                                 <div class="col-md-6 text-center mar">
                                       <div class="row">
                                           <div class="col-md-12 ">
                                               <div class="clearfix grey_bg">
                                                   <a class="project_img" href="<?php echo $this->Html->url(array('controller' =>'investments','action' =>'invest_detail',$investment['BasicsDetail']['project_id'])); ?>">
