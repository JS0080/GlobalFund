          ...
          <?php echo  $this->Form->create(array('controller' =>'users','action' =>'signups','id' =>'investor1')); ?>
            ...
            <input type="hidden" name="data[User][user_type]" value="investor">
              ...
              <div class="form-group col-md-12">
                <input type="text" class="form-control" id="user_email" name="data[User][username]" placeholder="example@.com">
              </div>
              <div class="form-group col-md-6">
...
<!--              <button type="submit" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
            ...
            <div class="modal-body clearfix">
              ...
              <p class="col-md-12"><b>Email Address *</b></p>	
              <div class="form-group col-md-12">
                <input type="text" class="form-control" id="user_name" name="data[User][username]" placeholder="example@.com">
              </div>
              ...
              data: {
                username: function() {
                  return $("#user_email").val();
                    ...
                    //remote: {url: '<?php //echo SITEPATH; ?>' + 'users/checkEmail', type: "post"}
...
//                }
            ...
            messages: {
                ...
                "data[User][address1]": {
                    required: "Address1 should not be blank.<br/>"

                },
                
                "data[User][address2]": {
                    required: "Address2 should not be blank.<br/>"
                ...
                "data[User][pin_code]": {
                    required: "Pin code should not be blank.<br/>"
...
//                }
            ...
            messages: {
                ...
                "data[User][phone]": {
                    required: "Phone no. should not be blank.<br/>"
