                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="<?php echo $this->html->url(array('controller' => 'contents', 'action' => 'admin_home_view', $homeDetail['Content']['id'])); ?>"><?php echo $this->html->image('view.png', array('title' => 'View')) ?></a>
                                    <a href="<?php echo $this->html->url(array('controller' => 'contents', 'action' => 'admin_home_edit', $homeDetail['Content']['id'])); ?>"><?php echo $this->html->image('edit-24.png', array('title' => 'Edit')) ?></a>    
