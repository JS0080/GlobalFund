    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body"> 
            ...
            <ul class="list-unstyled list-inline">      
               ...
               <li><a href="<?php echo $this->html->url(array('controller' => 'messages', 'action' => 'listing_sent_message')); ?>">
                   <button type="button" class="btn btn-primary">Sent Mail</button></a></li>    
                   
               <li><a href="<?php echo $this->html->url(array('controller' => 'messages', 'action' => 'listing_trash_list')); ?>">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="<?php echo $class; ?>" scope="row">
                         ...
                         <a  href="<?php echo $this->html->url(array('controller' => 'messages', 'action' => 'listing_sent_view_message',$message['MessageUser']['id'])); ?>">
                            <?php echo $toUser['User']['first_name']." ".$toUser['User']['last_name'] ?> </a> </td>
                        ...
                        <td class="<?php echo $class; ?>">
                         <a  href="<?php echo $this->html->url(array('controller' => 'messages', 'action' => 'listing_sent_view_message',$message['MessageUser']['id'])); ?>">
                           <?php  echo date('M j Y', strtotime($message['Message']['created'])); ?></a> </td> 
