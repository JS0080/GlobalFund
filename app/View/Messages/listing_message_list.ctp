                ...
                <tbody>
                    ...
                    <tr>
                        <td class="<?php echo $class; ?>" scope="row">
                         <a href="<?php echo $this->html->url(array('controller' => 'messages', 'action' => 'listing_view_message',$message['MessageUser']['id'])); ?>">
                            <?php echo $message['Sender']['first_name']." ".$message['Sender']['last_name'] ?> </a> </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                ...
                <?php echo $this->Form->create('Message', array('controller' => 'messages', 'action' => 'listing_send_message', 'class' => 'form-horizontal','id' =>'compose')); ?>
